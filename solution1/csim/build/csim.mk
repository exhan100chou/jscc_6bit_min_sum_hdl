...
HLS_SOURCES = ../../../main.cpp ../../../ldpcDec.cpp
...
$(ObjDir)/ldpcDec.o: ../../../ldpcDec.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../ldpcDec.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/ldpcDec.d

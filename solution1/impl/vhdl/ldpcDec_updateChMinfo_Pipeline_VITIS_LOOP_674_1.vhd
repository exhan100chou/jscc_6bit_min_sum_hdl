...
entity ldpcDec_updateChMinfo_Pipeline_VITIS_LOOP_674_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ldpcDec_updateChMinfo_Pipeline_VITIS_LOOP_674_1 is 
    ...
    constant ap_const_lv56_2E : STD_LOGIC_VECTOR (55 downto 0) := "00000000000000000000000000000000000000000000000000101110";
    constant ap_const_lv56_2F : STD_LOGIC_VECTOR (55 downto 0) := "00000000000000000000000000000000000000000000000000101111";
    constant ap_const_lv56_18 : STD_LOGIC_VECTOR (55 downto 0) := "00000000000000000000000000000000000000000000000000011000";
    constant ap_const_lv56_30 : STD_LOGIC_VECTOR (55 downto 0) := "00000000000000000000000000000000000000000000000000110000";
...
attribute shreg_extract : string;
    ...
    signal i_2_reg_369 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal rhs_3_reg_404 : STD_LOGIC_VECTOR (5 downto 0);
    signal ret_2_fu_196_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ret_2_reg_409 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_s_fu_134_p3 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_129_fu_143_p3 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_131_fu_152_p3 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_130_fu_166_p3 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_3_fu_306_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal icmp_ln1080_3_fu_316_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln70_3_fu_349_p1 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                i_2_reg_369 <= ap_sig_allocacmp_i_2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start_int = ap_const_logic_1) and (icmp_ln674_fu_122_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    minfo_ch_addr_1_reg_383(7 downto 0) <= tmp_129_fu_143_p3(15 - 1 downto 0)(7 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                ret_2_reg_409 <= ret_2_fu_196_p2;
                rhs_3_reg_404 <= minfo_ch_q0;
                rhs_reg_399 <= minfo_ch_q1;
            end if;
        end if;
    end process;
    minfo_ch_addr_reg_377(14 downto 8) <= "0101110";
    minfo_ch_addr_1_reg_383(14 downto 8) <= "0101111";
    ...
    add_ln1540_fu_252_p2 <= std_logic_vector(unsigned(ret_2_reg_409) + unsigned(sext_ln1540_fu_245_p1));
    add_ln674_fu_128_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_2) + unsigned(ap_const_lv8_1));
    ...
    ap_sig_allocacmp_i_2_assign_proc : process(ap_CS_fsm_state1, i_fu_64, ap_loop_init)
    begin
    ...
    blockllr_ch_address0 <= tmp_131_fu_152_p3(14 - 1 downto 0);
    ...
    icmp_ln1080_3_fu_316_p2 <= "1" when (signed(tmp_3_fu_306_p4) > signed(ap_const_lv4_0)) else "0";
    icmp_ln1080_4_fu_212_p2 <= "1" when (signed(tmp_4_fu_202_p4) > signed(ap_const_lv3_0)) else "0";
    icmp_ln1080_fu_277_p2 <= "1" when (signed(tmp_fu_267_p4) > signed(ap_const_lv4_0)) else "0";
    icmp_ln674_fu_122_p2 <= "1" when (ap_sig_allocacmp_i_2 = ap_const_lv8_A0) else "0";

    minfo_ch_address0_assign_proc : process(ap_CS_fsm_state1, icmp_ln674_fu_122_p2, ap_CS_fsm_state3, minfo_ch_addr_reg_377, ap_CS_fsm_state2, tmp_129_fu_143_p3, tmp_130_fu_166_p3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            minfo_ch_address0 <= minfo_ch_addr_reg_377;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            minfo_ch_address0 <= tmp_130_fu_166_p3(15 - 1 downto 0);
        elsif (((icmp_ln674_fu_122_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            minfo_ch_address0 <= tmp_129_fu_143_p3(15 - 1 downto 0);
        else 
    ...
    ret_2_fu_196_p2 <= std_logic_vector(signed(sext_ln232_2_fu_188_p1) + signed(sext_ln232_3_fu_192_p1));
    ret_fu_182_p2 <= std_logic_vector(signed(sext_ln232_fu_174_p1) + signed(sext_ln232_1_fu_178_p1));
    select_ln685_1_fu_322_p3 <= 
        ap_const_lv9_1F when (icmp_ln1080_3_fu_316_p2(0) = '1') else 
        sub_ln70_1_fu_300_p2;
    select_ln685_2_fu_218_p3 <= 
        ap_const_lv8_1F when (icmp_ln1080_4_fu_212_p2(0) = '1') else 
        ret_2_fu_196_p2;
    ...
    sext_ln1540_fu_245_p0 <= minfo_ch_q0;
        ...
        sext_ln1541_1_fu_297_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(rhs_3_reg_404),9));
    ...
    tmp_129_fu_143_p3 <= (ap_const_lv56_2F & ap_sig_allocacmp_i_2);
    tmp_130_fu_166_p3 <= (ap_const_lv56_30 & i_2_reg_369);
    tmp_131_fu_152_p3 <= (ap_const_lv56_18 & ap_sig_allocacmp_i_2);
    tmp_3_fu_306_p4 <= sub_ln70_1_fu_300_p2(8 downto 5);
    tmp_4_fu_202_p4 <= ret_2_fu_196_p2(7 downto 5);
    tmp_fu_267_p4 <= sub_ln70_fu_261_p2(8 downto 5);
    tmp_s_fu_134_p3 <= (ap_const_lv56_2E & ap_sig_allocacmp_i_2);
    trunc_ln70_3_fu_349_p1 <= select_ln685_1_fu_322_p3(6 - 1 downto 0);
    trunc_ln70_4_fu_232_p1 <= select_ln685_2_fu_218_p3(6 - 1 downto 0);
